			...
			<>
				...
				<div className="main" style={{ transform: "tanslateZ(0)" }}>
					...
					<Page background="#FFFFFF" colour="#000000" info={[
						...
						{ type: "copy", content: "I also have about 18 months experience in React Native, as can be seen in MobileTrainTimes, and a number of smaller experiemental projects." },
